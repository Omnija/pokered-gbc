...
;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	const PAL_SHINY_VENUSAUR   ; $27
	const PAL_SHINY_CHARMANDER ; $28
	const PAL_SHINY_CHARMELEON ; $29
	const PAL_SHINY_CHARIZARD  ; $2A
	const PAL_SHINY_SQUIRTLE   ; $2B
	const PAL_SHINY_WARTORTLE  ; $2C
	const PAL_SHINY_BLASTOISE  ; $2D
	const PAL_SHINY_CATERPIE   ; $2E
	const PAL_SHINY_METAPOD    ; $2F
	const PAL_SHINY_BUTTERFREE ; $30
	const PAL_SHINY_WEEDLE     ; $31
	const PAL_SHINY_KAKUNA     ; $32
	const PAL_SHINY_BEEDRILL   ; $33
	const PAL_SHINY_PIDGEY     ; $34
	const PAL_SHINY_PIDGEOTTO  ; $35
	const PAL_SHINY_PIDGEOT    ; $36
	const PAL_SHINY_RATTATA    ; $37
	const PAL_SHINY_RATICATE   ; $38
	const PAL_SHINY_SPEAROW    ; $39
	const PAL_SHINY_FEAROW     ; $3A
	const PAL_SHINY_EKANS      ; $3B
	const PAL_SHINY_ARBOK      ; $3C
	const PAL_SHINY_PIKACHU    ; $3D
	const PAL_SHINY_RAICHU     ; $3E
	const PAL_SHINY_SANDSHREW  ; $3F
	const PAL_SHINY_SANDSLASH  ; $40
	const PAL_SHINY_NIDORAN_F  ; $41
	const PAL_SHINY_NIDORINA   ; $42
	const PAL_SHINY_NIDOQUEEN  ; $43
	const PAL_SHINY_NIDORAN_M  ; $44
	const PAL_SHINY_NIDORINO   ; $45
	const PAL_SHINY_NIDOKING   ; $46
	const PAL_SHINY_CLEFAIRY   ; $47
	const PAL_SHINY_CLEFABLE   ; $48
	const PAL_SHINY_VULPIX     ; $49
	const PAL_SHINY_NINETALES  ; $4A
	const PAL_SHINY_JIGGLYPUFF ; $4B
	const PAL_SHINY_WIGGLYTUFF ; $4C
	const PAL_SHINY_ZUBAT      ; $4D
	const PAL_SHINY_GOLBAT     ; $4E
	const PAL_SHINY_ODDISH     ; $4F
	const PAL_SHINY_GLOOM      ; $50
	const PAL_SHINY_VILEPLUME  ; $51
	const PAL_SHINY_PARAS      ; $52
	const PAL_SHINY_PARASECT   ; $53
	const PAL_SHINY_VENONAT    ; $54
	const PAL_SHINY_VENOMOTH   ; $55
	const PAL_SHINY_DIGLETT    ; $56
	const PAL_SHINY_DUGTRIO    ; $57
	const PAL_SHINY_MEOWTH     ; $58
	const PAL_SHINY_PERSIAN    ; $59
	const PAL_SHINY_PSYDUCK    ; $5A
	const PAL_SHINY_GOLDUCK    ; $5B
	const PAL_SHINY_MANKEY     ; $5C
	const PAL_SHINY_PRIMEAPE   ; $5D
	const PAL_SHINY_GROWLITHE  ; $5E
	const PAL_SHINY_ARCANINE   ; $5F
	const PAL_SHINY_POLIWAG    ; $60
	const PAL_SHINY_POLIWHIRL  ; $61
	const PAL_SHINY_POLIWRATH  ; $62
	const PAL_SHINY_ABRA       ; $63
	const PAL_SHINY_KADABRA    ; $64
	const PAL_SHINY_ALAKAZAM   ; $65
	const PAL_SHINY_MACHOP     ; $66
	const PAL_SHINY_MACHOKE    ; $67
	const PAL_SHINY_MACHAMP    ; $68
	const PAL_SHINY_BELLSPROUT ; $69
	const PAL_SHINY_WEEPINBELL ; $6A
	const PAL_SHINY_VICTREEBEL ; $6B
	const PAL_SHINY_TENTACOOL  ; $6C
	const PAL_SHINY_TENTACRUEL ; $6D
	const PAL_SHINY_GEODUDE    ; $6E
	const PAL_SHINY_GRAVELER   ; $6F
	const PAL_SHINY_GOLEM      ; $70
	const PAL_SHINY_PONYTA     ; $71
	const PAL_SHINY_RAPIDASH   ; $72
	const PAL_SHINY_SLOWPOKE   ; $73
	const PAL_SHINY_SLOWBRO    ; $74
	const PAL_SHINY_MAGNEMITE  ; $75
	const PAL_SHINY_MAGNETON   ; $76
	const PAL_SHINY_FARFETCH_D ; $77
	const PAL_SHINY_DODUO      ; $78
	const PAL_SHINY_DODRIO     ; $79
	const PAL_SHINY_SEEL       ; $7A
	const PAL_SHINY_DEWGONG    ; $7B
	const PAL_SHINY_GRIMER     ; $7C
	const PAL_SHINY_MUK        ; $7D
	const PAL_SHINY_SHELLDER   ; $7E
	const PAL_SHINY_CLOYSTER   ; $7F
	const PAL_SHINY_GASTLY     ; $80
	const PAL_SHINY_HAUNTER    ; $81
	const PAL_SHINY_GENGAR     ; $82
	const PAL_SHINY_ONIX       ; $83
	const PAL_SHINY_DROWZEE    ; $84
	const PAL_SHINY_HYPNO      ; $85
	const PAL_SHINY_KRABBY     ; $86
	const PAL_SHINY_KINGLER    ; $87
	const PAL_SHINY_VOLTORB    ; $88
	const PAL_SHINY_ELECTRODE  ; $89
	const PAL_SHINY_EXEGGCUTE  ; $8A
	const PAL_SHINY_EXEGGUTOR  ; $8B
	const PAL_SHINY_CUBONE     ; $8C
	const PAL_SHINY_MAROWAK    ; $8D
	const PAL_SHINY_HITMONLEE  ; $8E
	const PAL_SHINY_HITMONCHAN ; $8F
	const PAL_SHINY_LICKITUNG  ; $90
	const PAL_SHINY_KOFFING    ; $91
	const PAL_SHINY_WEEZING    ; $92
	const PAL_SHINY_RHYHORN    ; $93
	const PAL_SHINY_RHYDON     ; $94
	const PAL_SHINY_CHANSEY    ; $95
	const PAL_SHINY_TANGELA    ; $96
	const PAL_SHINY_KANGASKHAN ; $97
	const PAL_SHINY_HORSEA     ; $98
	const PAL_SHINY_SEADRA     ; $99
	const PAL_SHINY_GOLDEEN    ; $9A
	const PAL_SHINY_SEAKING    ; $9B
	const PAL_SHINY_STARYU     ; $9C
	const PAL_SHINY_STARMIE    ; $9D
	const PAL_SHINY_MR_MIME    ; $9E
	const PAL_SHINY_SCYTHER    ; $9F
	const PAL_SHINY_JYNX       ; $A0
	const PAL_SHINY_ELECTABUZZ ; $A1
	const PAL_SHINY_MAGMAR     ; $A2
	const PAL_SHINY_PINSIR     ; $A3
	const PAL_SHINY_TAUROS     ; $A4
	const PAL_SHINY_MAGIKARP   ; $A5
	const PAL_SHINY_GYARADOS   ; $A6
	const PAL_SHINY_LAPRAS     ; $A7
	const PAL_SHINY_DITTO      ; $A8
	const PAL_SHINY_EEVEE      ; $A9
	const PAL_SHINY_VAPOREON   ; $AA
	const PAL_SHINY_JOLTEON    ; $AB
	const PAL_SHINY_FLAREON    ; $AC
	const PAL_SHINY_PORYGON    ; $AD
	const PAL_SHINY_OMANYTE    ; $AE
	const PAL_SHINY_OMASTAR    ; $AF
	const PAL_SHINY_KABUTO     ; $B0
	const PAL_SHINY_KABUTOPS   ; $B1
	const PAL_SHINY_AERODACTYL ; $B2
	const PAL_SHINY_SNORLAX    ; $B3
	const PAL_SHINY_ARTICUNO   ; $B4
	const PAL_SHINY_ZAPDOS     ; $B5
	const PAL_SHINY_MOLTRES    ; $B6
	const PAL_SHINY_DRATINI    ; $B7
	const PAL_SHINY_DRAGONAIR  ; $B8
