RocketHideoutB1F_Object:
	...
	def_objects
	object SPRITE_ROCKET_F, 26, 8, STAY, LEFT, 1, OPP_ROCKET_F, 8 ; OPP_ROCKET
	object SPRITE_ROCKET, 12, 6, STAY, RIGHT, 2, OPP_ROCKET, 9
	object SPRITE_ROCKET_F, 18, 17, STAY, DOWN, 3, OPP_ROCKET_F, 10 ; OPP_ROCKET
	object SPRITE_ROCKET_F, 15, 25, STAY, RIGHT, 4, OPP_ROCKET_F, 11 ; OPP_ROCKET
