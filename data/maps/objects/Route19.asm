...
;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	object SPRITE_SWIMMER_F, 8, 43, STAY, LEFT, 7, OPP_SWIMMER_F, 12 ; SPRITE_SWIMMER_F
;	object SPRITE_SWIMMER, 8, 43, STAY, LEFT, 7, OPP_BEAUTY, 12
	object SPRITE_SWIMMER_F, 11, 43, STAY, RIGHT, 8, OPP_SWIMMER_F, 13 ; SPRITE_SWIMMER_F
;	object SPRITE_SWIMMER, 11, 43, STAY, RIGHT, 8, OPP_BEAUTY, 13
	object SPRITE_SWIMMER, 9, 42, STAY, UP, 9, OPP_SWIMMER, 8
	object SPRITE_SWIMMER_F, 10, 44, STAY, DOWN, 10, OPP_SWIMMER_F, 14 ; SPRITE_SWIMMER_F
