...
;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	object SPRITE_SWIMMER_F, 68, 11, STAY, UP, 2, OPP_SWIMMER_F, 15  ; SPRITE_SWIMMER_F
;	object SPRITE_SWIMMER, 68, 11, STAY, UP, 2, OPP_BEAUTY, 15
	object SPRITE_SWIMMER_F, 45, 10, STAY, DOWN, 3, OPP_SWIMMER_F, 6 ; SPRITE_SWIMMER_F
;	object SPRITE_SWIMMER, 45, 10, STAY, DOWN, 3, OPP_BEAUTY, 6
	object SPRITE_SWIMMER_F, 55, 14, STAY, RIGHT, 4, OPP_JR_TRAINER_F, 24 ; SPRITE_SWIMMER_F
;	object SPRITE_SWIMMER, 55, 14, STAY, RIGHT, 4, OPP_JR_TRAINER_F, 24
	...
	object SPRITE_SWIMMER_F, 25, 7, STAY, UP, 8, OPP_SWIMMER_F, 7 ; SPRITE_SWIMMER_F
;	object SPRITE_SWIMMER, 25, 7, STAY, UP, 8, OPP_BEAUTY, 7
	object SPRITE_SWIMMER_F, 24, 12, STAY, DOWN, 9, OPP_JR_TRAINER_F, 16 ; SPRITE_SWIMMER_F
;	object SPRITE_SWIMMER, 24, 12, STAY, DOWN, 9, OPP_JR_TRAINER_F, 16
	object SPRITE_SWIMMER_F, 15, 8, STAY, UP, 10, OPP_SWIMMER_F, 8 ; SPRITE_SWIMMER_F
