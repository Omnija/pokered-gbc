MonGenderRatios:
	...
	db SAME_BOTH_GENDERS ; MANBOO		; db NO_GENDER         ; MISSINGNO_73
	...
	db SAME_BOTH_GENDERS ; SANKOR		; db NO_GENDER         ; MISSINGNO_79
	db SAME_BOTH_GENDERS ; GROTESQUE	; db NO_GENDER         ; MISSINGNO_7A
