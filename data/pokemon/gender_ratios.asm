MonGenderRatios:
	...
	db SAME_BOTH_GENDERS ; LICKILONG	; db NO_GENDER         ; MISSINGNO_1F
	db SAME_BOTH_GENDERS ; CROBAT		; db NO_GENDER         ; MISSINGNO_20
	...
	db SAME_BOTH_GENDERS ; SWANDOE		; db NO_GENDER         ; MISSINGNO_32
	db MALE_75_PERCENT   ; MAGMAR
	db SAME_BOTH_GENDERS ; STEELIX		; db NO_GENDER         ; MISSINGNO_34
	db MALE_75_PERCENT   ; ELECTABUZZ
	db NO_GENDER         ; MAGNETON
	db SAME_BOTH_GENDERS ; KOFFING
	db SAME_BOTH_GENDERS ; KINGDRA		; db NO_GENDER         ; MISSINGNO_38
	db SAME_BOTH_GENDERS ; MANKEY
	db SAME_BOTH_GENDERS ; SEEL
	db SAME_BOTH_GENDERS ; DIGLETT
	db MALE_ONLY         ; TAUROS
	db SAME_BOTH_GENDERS ; SCIZOR		; db NO_GENDER         ; MISSINGNO_3D
	db SAME_BOTH_GENDERS ; TANGALINE	; db NO_GENDER         ; MISSINGNO_3E
	db SAME_BOTH_GENDERS ; SLOWKING 	;db NO_GENDER          ; MISSINGNO_3F
	db NO_GENDER         ; FARFETCHD
	db SAME_BOTH_GENDERS ; VENONAT
	db SAME_BOTH_GENDERS ; DRAGONITE
	db SAME_BOTH_GENDERS ; MURMUDER		; db NO_GENDER         ; MISSINGNO_43
	db SAME_BOTH_GENDERS ; POLITOED		; db NO_GENDER         ; MISSINGNO_44
	db FEMALE_ONLY       ; KISSLEY		; db NO_GENDER         ; MISSINGNO_45
	...
	db MALE_88_PERCENT   ; LEAFEON		; db NO_GENDER         ; MISSINGNO_4F
	db MALE_88_PERCENT   ; ESPEON		; db NO_GENDER         ; db NO_GENDER         ; MISSINGNO_50
	db MALE_88_PERCENT   ; UMBREON		; db NO_GENDER         ; db NO_GENDER         ; MISSINGNO_51
	db FEMALE_75_PERCENT ; VULPIX
	db FEMALE_75_PERCENT ; NINETALES
	db SAME_BOTH_GENDERS ; PIKACHU
	db SAME_BOTH_GENDERS ; RAICHU
	db MALE_88_PERCENT   ; GLACEON		; db NO_GENDER         ; MISSINGNO_56
	db FEMALE_75_PERCENT ; SYLVEON		; db NO_GENDER         ; MISSINGNO_57
	...
	db SAME_BOTH_GENDERS ; HITMON		; db NO_GENDER         ; MISSINGNO_5E
	db SAME_BOTH_GENDERS ; HITMONTOP	; db NO_GENDER         ; MISSINGNO_5F
	...
	db NO_GENDER         ; MISSINGNO_73	; db SAME_BOTH_GENDERS ; MANBOO
	...
	db NO_GENDER         ; MISSINGNO_79	; db SAME_BOTH_GENDERS ; SANKOR
	db NO_GENDER         ; MISSINGNO_7A ; db SAME_BOTH_GENDERS ; GROTESQUE
