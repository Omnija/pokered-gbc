...
ELSE
	...
	db PAL_BLUEMON   ; CROBAT		; New pokemon
	...
	db PAL_GREENMON  ; POLITOED		; New pokemon
	...
	db PAL_REDMON    ; SCIZOR		; New pokemon
	db PAL_MEWMON    ; JYNX
	...
	db PAL_GREENMON  ; LEAFEON		; New pokemon
	db PAL_PINKMON   ; ESPEON		; New pokemon
	db PAL_GREYMON   ; UMBREON		; New pokemon
	db PAL_BLUEMON   ; GLACEON		; New pokemon
	db PAL_PINKMON   ; SYLVEON		; New pokemon
