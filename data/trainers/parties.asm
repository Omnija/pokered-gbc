...
; Unused
	db "X@", 18, METAPOD, CATERPIE, VENONAT, -1
; Route 9
...
; Unused
	db "X@", 18, DIGLETT, DIGLETT, SANDSHREW, -1
; Route 9
...
; Unused
	db "X@", 22, KOFFING, MAGNEMITE, WEEZING, -1
	db "X@", 20, MAGNEMITE, MAGNEMITE, KOFFING, MAGNEMITE, -1
	db "X@", 24, MAGNEMITE, VOLTORB, -1
; Cinnabar Gym
...
BurglarData:
; Unused
	db "X@", 29, GROWLITHE, VULPIX, -1
	db "X@", 33, GROWLITHE, -1
	db "X@", 28, VULPIX, CHARMANDER, PONYTA, -1
; Cinnabar Gym
...
; Route 17
	...
	db "JAMAL@", 26, MANKEY, MANKEY, MACHOKE, MACHOP, -1
...
; Unused
	db "X@", 22, ONIX, GEODUDE, GRAVELER, -1
; Route 8
...
; Unused
	db "X@", 33, WEEPINBELL, BELLSPROUT, WEEPINBELL, -1
; Route 19
...
; Unused
	db "X@", 42, RHYHORN, PRIMEAPE, ARBOK, TAUROS, -1
...
; Unused
	db "X@", 39, PIDGEOTTO, PIDGEOTTO, PIDGEY, PIDGEOTTO, -1
	db "X@", 42, FARFETCHD, FEAROW, -1
; Route 14
...
GiovanniData:
; Rocket Hideout B4F
	db "GIOVANNI@", $FF, 25, ONIX, 24, RHYHORN, 29, KANGASKHAN, -1
; Silph Co. 11F
	db "GIOVANNI@", $FF, 37, NIDORINO, 35, KANGASKHAN, 37, RHYHORN, 41, NIDOQUEEN, -1
; Viridian Gym
;	db "GIOVANNI@", $FF, 45, RHYHORN, 42, DUGTRIO, 44, NIDOQUEEN, 45, NIDOKING, 50, RHYDON, -1
	db "GIOVANNI@",MOVES
...
CooltrainerMData:
; Viridian Gym
	db "SAUL@", 39, NIDORINO, NIDOKING, -1
; Victory Road 3F
	db "BEN@", 43, EXEGGUTOR, CLOYSTER, ARCANINE, -1
	db "COLBY@", 43, KINGLER, TENTACRUEL, BLASTOISE, -1
; Unused
	db "X@", 45, KINGLER, STARMIE, -1
; Victory Road 1F
	db "HANK@", 42, IVYSAUR, WARTORTLE, CHARMELEON, CHARIZARD, -1
; Unused
	db "X@", 44, IVYSAUR, WARTORTLE, CHARMELEON, -1
	db "X@", 49, NIDOKING, -1
	db "X@", 44, KINGLER, CLOYSTER, -1
; Viridian Gym
	db "YUJI@", 39, SANDSLASH, DUGTRIO, -1
	db "WREN@", 43, RHYHORN, -1

CooltrainerFData:
; Celadon Gym
	db "MARY@", 24, WEEPINBELL, GLOOM, IVYSAUR, -1
; Victory Road 3F
	db "TINA@", 43, BELLSPROUT, WEEPINBELL, VICTREEBEL, -1
	db "ALEXA@", 43, PARASECT, DEWGONG, CHANSEY, -1
; Unused
	db "X@", 46, VILEPLUME, BUTTERFREE, -1
; Victory Road 1F
	db "NAOMI@", 44, PERSIAN, NINETALES, -1
; Unused
	db "X@", 45, IVYSAUR, VENUSAUR, -1
	db "X@", 45, NIDORINA, NIDOQUEEN, -1
	db "X@", 43, PERSIAN, NINETALES, RAICHU, -1

BrunoData:
;	db "BRUNO@", $FF, 53, ONIX, 55, HITMONCHAN, 55, HITMONLEE, 56, ONIX, 58, MACHAMP, -1
	db "BRUNO@",MOVES
...
BrockData:
;	db "BROCK@", $FF, 12, GEODUDE, 14, ONIX, -1
	db "BROCK@",MOVES
...
MistyData:
;	db "MISTY@", $FF, 18, STARYU, 21, STARMIE, -1
	db "MISTY@",MOVES
...
LtSurgeData:
;	db "LT.SURGE@", $FF, 21, VOLTORB, 18, PIKACHU, 24, RAICHU, -1
	db "LT.SURGE@",MOVES
...
ErikaData:
;	db "ERIKA@", $FF, 29, VICTREEBEL, 24, TANGELA, 29, VILEPLUME, -1
	db "ERIKA@",MOVES
...
KogaData:
;	db "KOGA@", $FF, 37, KOFFING, 39, MUK, 37, KOFFING, 43, WEEZING, -1
	db "KOGA@",MOVES
...
BlaineData:
;	db "BLAINE@", $FF, 42, GROWLITHE, 40, PONYTA, 42, RAPIDASH, 47, ARCANINE, -1
	db "BLAINE@",MOVES
...
SabrinaData:
;	db "SABRINA@", $FF, 38, KADABRA, 37, MR_MIME, 38, VENOMOTH, 43, ALAKAZAM, -1
	db "SABRINA@",MOVES
...
Green3Data:
;	db "<RIVAL>@", $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, ARCANINE, 63, EXEGGUTOR, 65, BLASTOISE, -1
;	db "<RIVAL>@", $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, GYARADOS, 63, ARCANINE, 65, VENUSAUR, -1
;	db "<RIVAL>@", $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, EXEGGUTOR, 63, GYARADOS, 65, CHARIZARD, -1
...
LoreleiData:
;	db "LORELEI@", $FF, 54, DEWGONG, 53, CLOYSTER, 54, SLOWBRO, 56, JYNX, 56, LAPRAS, -1
	db "LORELEI@",MOVES
...
AgathaData:
;	db "AGATHA@", $FF, 56, GENGAR, 56, GOLBAT, 55, HAUNTER, 58, ARBOK, 60, GENGAR, -1
	db "AGATHA@",MOVES
...
LanceData:
;	db "LANCE@", $FF, 58, GYARADOS, 56, DRAGONAIR, 56, DRAGONAIR, 60, AERODACTYL, 62, DRAGONITE, -1
	db "LANCE@",MOVES
